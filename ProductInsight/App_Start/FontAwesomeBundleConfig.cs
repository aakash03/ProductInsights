...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(ProductInsight.App_Start.FontAwesomeBundleConfig), "RegisterBundles")]

namespace ProductInsight.App_Start
{
	public class FontAwesomeBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new StyleBundle("~/Content/fontawesome/fa").Include("~/Content/fontawesome/font-awesome.css"));
		}
	}
}